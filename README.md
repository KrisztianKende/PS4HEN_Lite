...
<ins>But I don't take any credit for the source code because I didn't add anything to it!</ins>

The goal was to build a lightweight HEN, like GoldHEN Lite (which unfortunately only supports 9.00).  
Sure, originally the PS4HEN was also lightweight, but that changed over time.
